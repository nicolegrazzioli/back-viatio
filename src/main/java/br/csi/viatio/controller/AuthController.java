...
import br.csi.viatio.model.user.LoginRequest;
import br.csi.viatio.model.user.RegisterRequest;
import br.csi.viatio.model.user.TokenResponse;
import br.csi.viatio.model.user.User;
import br.csi.viatio.model.user.UserRepository;
import br.csi.viatio.model.user.UserResponse;
